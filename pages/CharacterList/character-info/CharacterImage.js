        ...
        <Row className="character-info-character-row">
          ...
          <div className="character-info-character-image-wrapper">
            <div className="character-info-character-image">
              <Image layout="fill" unoptimized="true" src={image.ascension_0} alt="migard_asc0"></Image>
            </div>
          </div>
          </Col>
        </Row>
    ...
    return(
      <Container>
        <Row className="character-info-character-row">
          ...
          <div className="character-info-character-image-wrapper">
            <div className="character-info-character-image">
              <Image layout="fill" unoptimized="true" src={image.ascension_3} alt="migard_asc0"></Image>
            </div>
          </div>
          </Col>
        </Row>
